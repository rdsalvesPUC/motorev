...
BEGIN TRY
    ...
    -- Ana has one motorcycle per appointment scenario. The first review date is always
    -- generated by the real rule: DataVenda + 6 months.
    INSERT INTO @Motos
        ([UserId], [Placa], [Chassi], [NomeModelo], [Cor], [KilometragemAtual], [DataVenda])
    VALUES
        (N'SEED-CLI-001', N'SCA1A01', N'9C2SEEDCLI0010001', N'CG 160', N'Vermelha', 12450, DATEADD(MONTH, -6, DATEADD(DAY, 5, @Hoje))),
        (N'SEED-CLI-001', N'SCA1A02', N'9C2SEEDCLI0010002', N'PCX 160', N'Branca', 3200, DATEADD(MONTH, -6, DATEADD(DAY, 4, @Hoje))),
        (N'SEED-CLI-001', N'SCA1A03', N'9C2SEEDCLI0010003', N'Factor 150', N'Preta', 8200, DATEADD(MONTH, -6, DATEADD(DAY, 7, @Hoje))),
        (N'SEED-CLI-001', N'SCA1A04', N'9C2SEEDCLI0010004', N'Fazer 250', N'Azul', 9400, DATEADD(MONTH, -6, DATEADD(DAY, -2, @Hoje))),
        (N'SEED-CLI-001', N'SCA1A05', N'9C2SEEDCLI0010005', N'NMAX 160', N'Cinza', 5100, DATEADD(MONTH, -6, DATEADD(DAY, -30, @Hoje))),
        (N'SEED-CLI-001', N'SCA1A06', N'9C2SEEDCLI0010006', N'CB 500F', N'Prata', 6800, DATEADD(MONTH, -6, DATEADD(DAY, 30, @Hoje))),
        (N'SEED-CLI-001', N'SCA1A07', N'9C2SEEDCLI0010007', N'NXR 160 Bros', N'Verde', 15100, DATEADD(MONTH, -6, DATEADD(DAY, -20, @Hoje))),
        (N'SEED-CLI-001', N'SCA1A08', N'9C2SEEDCLI0010008', N'XRE 300', N'Preta', 22400, DATEADD(MONTH, -6, DATEADD(DAY, -1, @Hoje))),

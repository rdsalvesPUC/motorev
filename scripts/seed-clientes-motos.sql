...
-- Requires scripts\seed-modelos-motos.sql to have been executed first.
...
BEGIN TRY
    ...
    VALUES
        (N'SEED-CLI-001', N'SCA1A01', N'9C2SEEDCLI0010001', N'CG 160', N'Vermelha', 12450, '2024-02-10'),
        (N'SEED-CLI-001', N'SCA1A02', N'9C2SEEDCLI0010002', N'PCX 160', N'Branca', 3200, '2024-08-21'),
        (N'SEED-CLI-002', N'SCB2B01', N'9C2SEEDCLI0020001', N'Factor 150', N'Preta', 18120, '2023-05-18'),
        (N'SEED-CLI-003', N'SCC3C01', N'9C2SEEDCLI0030001', N'Fazer 250', N'Azul', 8700, '2024-03-14'),
        (N'SEED-CLI-003', N'SCC3C02', N'9C2SEEDCLI0030002', N'NMAX 160', N'Cinza', 4600, '2024-09-02'),
        (N'SEED-CLI-004', N'SCD4D01', N'9C2SEEDCLI0040001', N'NXR 160 Bros', N'Verde', 15100, '2023-11-30'),
        (N'SEED-CLI-005', N'SCE5E01', N'9C2SEEDCLI0050001', N'XRE 300', N'Preta', 22400, '2023-01-25'),
        (N'SEED-CLI-005', N'SCE5E02', N'9C2SEEDCLI0050002', N'Meteor 350', N'Azul', 9300, '2024-01-11'),
        (N'SEED-CLI-006', N'SCF6F01', N'9C2SEEDCLI0060001', N'YZF-R3', N'Azul', 7600, '2024-04-08'),
        (N'SEED-CLI-007', N'SCG7G01', N'9C2SEEDCLI0070001', N'Crosser 150', N'Bege', 19900, '2023-07-19'),
        (N'SEED-CLI-007', N'SCG7G02', N'9C2SEEDCLI0070002', N'ADV 160', N'Cinza', 5200, '2024-06-05'),
        (N'SEED-CLI-008', N'SCH8H01', N'9C2SEEDCLI0080001', N'Ninja 400', N'Verde', 6100, '2024-05-12'),
        (N'SEED-CLI-009', N'SCI9I01', N'9C2SEEDCLI0090001', N'Lander 250', N'Azul', 14300, '2023-09-27'),
        (N'SEED-CLI-009', N'SCI9I02', N'9C2SEEDCLI0090002', N'CB 500F', N'Prata', 11800, '2023-12-16'),
        (N'SEED-CLI-010', N'SCJ0J01', N'9C2SEEDCLI0100001', N'G 310 GS', N'Branca', 6800, '2024-07-22');

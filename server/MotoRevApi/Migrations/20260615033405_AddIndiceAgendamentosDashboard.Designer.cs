...
namespace MotoRevApi.Migrations
{
    ...
    [Migration("20260615033405_AddIndiceAgendamentosDashboard")]
    partial class AddIndiceAgendamentosDashboard
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MotoRevApi.Model.RevisaoMoto", b =>
                {
                    ...
                    b.HasIndex("RevisaoPadraoId");

                    b.HasIndex("MotoId", "Ordem")
                        .IsUnique();

                    b.ToTable("RevisoesMotos");
                });
            ...
            modelBuilder.Entity("MotoRevApi.Model.Moto", b =>
                {
                    b.Navigation("RevisoesPlanejadas");
                });

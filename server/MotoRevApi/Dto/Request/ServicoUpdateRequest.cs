...
public record ServicoUpdateRequest
{
    ...
    public ServicoUpdateRequest() { }

    public ServicoUpdateRequest(string codigo, string nome, string descricao, CategoriaServico categoria, int tempoEstimado, decimal custo)
    {
        Codigo = codigo;
        Nome = nome;
        Descricao = descricao;
